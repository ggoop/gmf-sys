...
use Gmf\Sys\Http\Resources\Resource\ResourceCollection as GmfResourceC;
use Gmf\Sys\Http\Resources\Resource\Resource as GmfResource;
...
class APIResult
{
  public static function json($data, Closure $callback = null)
  {
    ...
    if ($data instanceof LengthAwarePaginator) {
      ...
      if (method_exists($data, 'toResult')) {
        $data = $data->toResult(Container::getInstance()->make('request'));
      } else {
