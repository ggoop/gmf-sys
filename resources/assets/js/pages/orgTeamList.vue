...
<script>
  export default {
    ...
    methods: {
      create(){
        this.$router.push({ name: 'module', params: { module: 'org.team.edit' }});
      },
      edit(item){
        this.$router.push({ name: 'id', params: { module: 'org.team.edit',id:item.id }});
      },
      remove(){
        ...
        this.$http.delete('org/teams/'+ids).then(response => {
          this.load();
          this.loading--;
