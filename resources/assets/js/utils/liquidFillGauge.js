...
function loadLiquidFillGauge(element, value, config) {
    ...
    var fillCircleGroup = gaugeGroup.append("g")
        .attr("clip-path", "url(#clipWave" + eid + ")");
    ...
    if (config.valueCountUp) {
        var textTween = function() {
            var s=this;
            var i = d3.interpolate(s.textContent, textFinalValue);
            return function(t) { s.textContent = textRounder(i(t)) + percentText; }
        };
        text1.transition()
    ...
    function GaugeUpdater() {
        this.update = function(value) {
            ...
            var textTween = function() {
                var s=this;
                var i = d3.interpolate(s.textContent, parseFloat(value).toFixed(2));
                return function(t) { s.textContent = textRounderUpdater(i(t)) + percentText; }
            };
