<template>
  <div class="md-input-ref layout layout-row" @click.native="applyInputFocus">
    <md-input-value v-for="(chip ,columnIndex) in selectedValues" :md-deletable="!disabled" :disabled="disabled" :key="chip.id" @delete="deleteChip(chip)">
...
import commonInput from '../MdFieldMixin';
import MdInputVue from './MdInputVue'
