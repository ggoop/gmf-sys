<template>
  <div class="layout flex md-ref-body-entity">
    <md-grid :auto-select="true" :auto-load="false" ref="grid" :datas="fetchData" :multiple="multiple" showQuery showDownload
      @select="onSelected" @dblclick="dblclick" @onQuery="openQueryCase">
    </md-grid>
  ...
  export default {
    ...
    methods: {
      ...
      onSelected({
        ...
        this.setData(this.selectedRows);
      },
      dblclick({
        data
      }) {
