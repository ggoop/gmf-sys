...
class CreateGmfSysAuthorityRoleDatasTable extends Migration {
	...
	public function up() {
		...
		$md->mdEntity('gmf.sys.authority.role.data')->comment('角色-数据')->tableName('gmf_sys_authority_role_datas');
