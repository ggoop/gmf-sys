...
const componentsPath = 'resources/assets/js/components'
const themePath = 'resources/assets/js/theme'
const basePath = 'resources/assets/js/base'
const componentList = getDirectories(resolvePath(componentsPath))

export default entry => {
  let entries = {
    [pack.name]: './resources/assets/js/index'
  }
